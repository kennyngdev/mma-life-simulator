...
- Seeds support replay, comparison, sharing, and debugging. Save compatibility is explicit through the run version; the eighteen-talent pool begins at save version 7, so earlier in-progress runs restart while legacy progression remains.
